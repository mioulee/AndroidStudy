        ...
        for (int i = 0; i < dates.size(); i++) {
            ...
            view.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    CalendarView_Horizontal calendarViewHorizontal = (CalendarView_Horizontal) getParent();
                    OnSingleChooseListener clickListener = calendarViewHorizontal.getSingleChooseListener();
                    OnMultiChooseListener chooseListener = calendarViewHorizontal.getMultiChooseListener();
                    if (date.getType() == 1) {//点击当月
                        if (mAttrsBean.getChooseType() == 1 && chooseListener != null) {//多选的情况
                            ...
                            calendarViewHorizontal.setChooseDate(day, flag, -1);
                            chooseListener.onMultiChoose(v, date, flag);
                        } else {
                            calendarViewHorizontal.setLastClickDay(day);
                        ...
                        calendarViewHorizontal.lastMonth();
                        if (clickListener != null) {
                            clickListener.onSingleChoose(v, date);
                        }
                        ...
                        calendarViewHorizontal.nextMonth();
                        if (clickListener != null) {
                            clickListener.onSingleChoose(v, date);
                        }
                    }
