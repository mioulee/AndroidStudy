...
public class CalendarView_Horizontal extends ViewPager {
    ...
    public CalendarView_Horizontal(Context context) {
        this(context, null);
    }

    public CalendarView_Horizontal(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void init() {
        ...
        mCalendarViewPagerAdapter = new CalendarViewPagerAdapter(count);
        mCalendarViewPagerAdapter.setAttrsBean(mAttrsBean);
        mCalendarViewPagerAdapter.setOnCalendarViewAdapter(item_layout, calendarViewAdapter);
        setAdapter(mCalendarViewPagerAdapter);
    ...
    private void refreshMonthView(int position) {
        MonthView monthView = mCalendarViewPagerAdapter.getViews().get(position);
     ...
     */
    public CalendarView_Horizontal setOnCalendarViewAdapter(int item_layout, CalendarViewAdapter calendarViewAdapter) {
     ...
     * 将指定日期的农历替换成对应文字
     */
    public CalendarView_Horizontal setSpecifyMap(HashMap<String, String> map) {
     ...
     * @return
     */
    public CalendarView_Horizontal setInitDate(String date) {
     ...
     * @return
     */
    public CalendarView_Horizontal setStartEndDate(String startDate, String endDate) {
     ...
     * @return
     */
    public CalendarView_Horizontal setMultiDate(List<String> dates) {
     ...
     * @return
     */
    public CalendarView_Horizontal setSingleDate(String date) {
     ...
     * @return
     */
    public CalendarView_Horizontal setDisableStartEndDate(String startDate, String endDate) {
