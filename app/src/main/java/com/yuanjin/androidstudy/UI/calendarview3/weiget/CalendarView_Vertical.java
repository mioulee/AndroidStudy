...
import com.yuanjin.androidstudy.UI.calendarview3.listener.OnMultiChooseListener;
import com.yuanjin.androidstudy.UI.calendarview3.listener.OnPagerChangeListener;
import com.yuanjin.androidstudy.UI.calendarview3.listener.OnSingleChooseListener;
...
public class CalendarView_Vertical extends RecyclerView {
    ...
    private CalendarRecyclerViewAdapter mCalendarRecylerAdapter;

    private AttrsBean mAttrsBean;
    private Context mContext;

    public CalendarView_Vertical(Context context) {
        this(context, null);
    }

    public CalendarView_Vertical(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
    ...
    public void init() {
        ...
        mCalendarRecylerAdapter = new CalendarRecyclerViewAdapter(mContext,R.layout.item_calendar,list);
        mCalendarRecylerAdapter.setAttrsBean(mAttrsBean);
        mCalendarRecylerAdapter.setOnCalendarViewAdapter(item_layout, calendarViewAdapter);
        setLayoutManager(new LinearLayoutManager(mContext));
        setAdapter(mCalendarRecylerAdapter);
...
//        MonthView monthView = mCalendarRecylerAdapter.getViews().get(position);
...
//        }
     ...
     */
    public CalendarView_Vertical setOnCalendarViewAdapter(int item_layout, CalendarViewAdapter calendarViewAdapter) {
...
//            setCurrentItem(currentPosition += 12, false);
     ...
     * 将指定日期的农历替换成对应文字
     */
    public CalendarView_Vertical setSpecifyMap(HashMap<String, String> map) {
     ...
     * @return
     */
    public CalendarView_Vertical setInitDate(String date) {
     ...
     * @return
     */
    public CalendarView_Vertical setStartEndDate(String startDate, String endDate) {
     ...
     * @return
     */
    public CalendarView_Vertical setMultiDate(List<String> dates) {
     ...
     * @return
     */
    public CalendarView_Vertical setSingleDate(String date) {
     ...
     * @return
     */
    public CalendarView_Vertical setDisableStartEndDate(String startDate, String endDate) {
