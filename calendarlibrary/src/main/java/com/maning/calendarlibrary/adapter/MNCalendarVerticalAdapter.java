...
public class MNCalendarVerticalAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private MNCalendarVerticalItemAdapter mMnCalendarVerticalItemAdapter;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof MyViewHolder) {
            ...
            mMnCalendarVerticalItemAdapter = new MNCalendarVerticalItemAdapter(context, dates, calendarItem, this, mnCalendarVerticalConfig);
            myViewHolder.recyclerViewItem.setAdapter(mMnCalendarVerticalItemAdapter);
        }
    }
    ...
    public void setLimitDate(Date date) {
        mLimitDate = date;
        if (mMnCalendarVerticalItemAdapter != null) {
            mMnCalendarVerticalItemAdapter.setLimitDate(date);
        }
    }
